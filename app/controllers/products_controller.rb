class ProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product.save
        format.html { redirect_to product_url(@product), notice: "#{@product.title} was successfully created." }
  ...
  def update
    respond_to do |format|
      if @product.update(product_params)
        format.html { redirect_to product_url(@product), notice: "#{@product.title} was successfully updated." }
